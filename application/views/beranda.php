<!DOCTYPE html>
	...
	<head>
		...
		<link href="<?= base_url();?>assets/https://fonts.googleapis.com/css?family=Poppins:100,200,400,300,500,600,700" rel="stylesheet"> 
			<!--
			CSS
			============================================= -->
			  ...
			  <header id="header" id="home">
		  			...
		  			<!-- <div class="container"> -->
				  		<!-- <div class="row"> -->
				  			<!-- <div class="col-lg-6 col-sm-6 col-4 header-top-left no-padding">
				  				<a href="<?= base_url();?>assets/tel:+953 012 3654 896">+953 012 3654 896</a>
				  				<a href="<?= base_url();?>assets/mailto:support@colorlib.com">support@colorlib.com</a>					  
				  			</div> -->
				  			<!-- <div class="col-lg-6 col-sm-6 col-8 header-top-right no-padding">
				  				<ul>
									<li><a href="<?= base_url();?>assets/#"><i class="fa fa-facebook"></i></a></li>
									<li><a href="<?= base_url();?>assets/#"><i class="fa fa-twitter"></i></a></li>
									<li><a href="<?= base_url();?>assets/#"><i class="fa fa-dribbble"></i></a></li>
									<li><a href="<?= base_url();?>assets/#"><i class="fa fa-behance"></i></a></li>
				  				</ul>			
				  			</div> -->
				  		<!-- </div>	-->
		  			<!-- </div> -->
			    ...
			    <div class="container main-menu">
			    	<div class="row align-items-center justify-content-between d-flex">
				      <div id="logo">
				        <a href="<?= base_url();?>assets/index.html"><img src="<?= base_url();?>assets/img/logo.png" alt="" title="" /></a>
				      </div>
				      <nav id="nav-menu-container">
						...
						<li><a href="<?= base_url();?>index.php/welcome/profil">Profil</a></li>
						  ...
						  <li><a href="<?= base_url();?>index.php/welcome/event">Events</a></li>
				...
				<div class="container">
					<div class="row fullscreen d-flex justify-content-center align-items-center">
						<div class="banner-content col-lg-9 col-md-12 justify-content-center ">
							...
							<a href="<?= base_url();?>assets/#" class="primary-btn header-btn text-uppercase mt-10">Get Started</a>
						</div>											
					</div>
				</div>
			</section>
					...
					<div class="row">
						<div class="col-lg-4">
							<div class="single-service">
								<a href="<?= base_url();?>assets/#"><h4>Interior Design</h4></a>
								<p>
						...
						<div class="col-lg-4">
							<div class="single-service">
								<a href="<?= base_url();?>assets/#"><h4>Architecture Design</h4></a>
								<p>
						...
						<div class="col-lg-4">
							<div class="single-service">
								<a href="<?= base_url();?>assets/#"><h4>Concept Design</h4></a>
								<p>
								...
								<div class="content">
								    <a href="<?= base_url();?>assets/#" target="_blank">
								      <div class="content-overlay"></div>
								  		 <img class="content-image img-fluid d-block mx-auto" src="<?= base_url();?>assets/img/g1.jpg" alt="">
								      <div class="content-details fadeIn-bottom">
								        <h3 class="content-title mx-auto">Lavendar ambient interior</h3>
								        <a href="<?= base_url();?>assets/project-details.html" class="primary-btn text-uppercase mt-20">More Details</a>
								      </div>
								    </a>
								</div>
							</div>
						...
						<div class="col-lg-4">
							<div class="single-gallery">
								<div class="content">
								    <a href="<?= base_url();?>assets/#" target="_blank">
								      <div class="content-overlay"></div>
								  		 <img class="content-image img-fluid d-block mx-auto" src="<?= base_url();?>assets/img/g2.jpg" alt="">
								      <div class="content-details fadeIn-bottom">
						...
						<div class="col-lg-4">
							<div class="single-gallery">
								<div class="content">
								    <a href="<?= base_url();?>assets/#" target="_blank">
								      <div class="content-overlay"></div>
								  		 <img class="content-image img-fluid d-block mx-auto" src="<?= base_url();?>assets/img/g3.jpg" alt="">
								      <div class="content-details fadeIn-bottom">
								        <h3 class="content-title mx-auto">Ambient interior</h3>
								        <a href="<?= base_url();?>assets/project-details.html" class="primary-btn text-uppercase mt-20">More Details</a>
								      </div>
						...
						<div class="col-lg-8">
							<div class="single-gallery">
								<div class="content">
								    <a href="<?= base_url();?>assets/#" target="_blank">
								      <div class="content-overlay"></div>
								  		 <img class="content-image img-fluid d-block mx-auto" src="<?= base_url();?>assets/img/g4.jpg" alt="">
								      <div class="content-details fadeIn-bottom">
								        <h3 class="content-title mx-auto">Lavendar ambient interior</h3>
								        <a href="<?= base_url();?>assets/project-details.html" class="primary-btn text-uppercase mt-20">More Details</a>
								      </div>
					...
					<div class="row">
						<div class="col-lg-4 col-md-6">
							<div class="single-feature">
								<a href="<?= base_url();?>assets/#" class="title d-flex flex-row align-items-center">
					...
					<div class="row justify-content-center">
						<div class="callto-action-wrap col-lg-12 relative section-gap">
							<div class="content">
								...
								<a href="<?= base_url();?>assets/#" class="primary-btn text-uppercase">Request quote now</a>			
							</div>							
						</div>
					</div>
				</div>	
						...
						<div class="active-blog-carusel">
							<div class="single-blog-post item">
								...
								<div class="details">
									<div class="tags">
										<ul>
											<li>
												<a href="<?= base_url();?>assets/#">Travel</a>
											</li>
											<li>
												<a href="<?= base_url();?>assets/#">Life Style</a>
											</li>											
										</ul>
									</div>
									<a href="<?= base_url();?>assets/#"><h4 class="title">Low Cost Advertising</h4></a>
									<p>
							...
							<div class="single-blog-post item">
								...
								<div class="details">
									...
									<a href="<?= base_url();?>assets/#"><h4 class="title">Creative Outdoor Ads</h4></a>
									<p>
										Acres of Diamonds… you’ve read the famous story, or at least had it related to you. A farmer.
									</p>
									<h6 class="date">31st January,2018</h6>
							...
							<div class="single-blog-post item">
								...
								<div class="details">
									...
									<a href="<?= base_url();?>assets/#"><h4 class="title">It's Classified How To Utilize Free</h4></a>
									<p>
										Acres of Diamonds… you’ve read the famous story, or at least had it related to you. A farmer.
									</p>
									<h6 class="date">31st January,2018</h6>
					...
					<div class="brand-wrap">
						<div class="row align-items-center active-brand-carusel justify-content-start no-gutters">
							<div class="col single-brand">
								<a href="<?= base_url();?>assets/#"><img class="mx-auto" src="<?= base_url();?>assets/img/l1.png" alt=""></a>
							</div>
							<div class="col single-brand">
								<a href="<?= base_url();?>assets/#"><img class="mx-auto" src="<?= base_url();?>assets/img/l2.png" alt=""></a>
							</div>
							<div class="col single-brand">
								<a href="<?= base_url();?>assets/#"><img class="mx-auto" src="<?= base_url();?>assets/img/l3.png" alt=""></a>
							</div>
							<div class="col single-brand">
								<a href="<?= base_url();?>assets/#"><img class="mx-auto" src="<?= base_url();?>assets/img/l4.png" alt=""></a>
							</div>
							<div class="col single-brand">
								<a href="<?= base_url();?>assets/#"><img class="mx-auto" src="<?= base_url();?>assets/img/l5.png" alt=""></a>
							</div>								
						</div>																			
					</div>
				</div>	
...
<!-- Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="<?= base_url();?>assets/https://colorlib.com" target="_blank">Colorlib</a> -->
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>								
			...
			<script type="text/javascript" src="<?= base_url();?>assets/https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script>
