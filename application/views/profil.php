				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="<?= base_url();?>assets/index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="<?= base_url();?>assets/about.html"> About Us</a></p>
						</div>	
					</div>
				</div>
			</section>
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 about-video-left">
							...
							<a class="primary-btn mt-30" href="<?= base_url();?>assets/#">Get Started Now</a>
						</div>
						<div class="col-lg-6 about-video-right justify-content-center align-items-center d-flex relative">
							<div class="overlay overlay-bg"></div>
							<a class="play-btn" href="<?= base_url();?>assets/https://www.youtube.com/watch?v=ARA0AxrnHdM"><img class="img-fluid mx-auto" src="<?= base_url();?>assets/img/play-btn.png" alt=""></a>
						</div>
					</div>
				</div>	
			</section>
